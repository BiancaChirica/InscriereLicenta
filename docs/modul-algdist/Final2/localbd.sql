...
--
-- Table structure for table `perioadainscrieri`
--

CREATE TABLE `perioadainscrieri` (
  `id` int(11) NOT NULL,
  `start_time` datetime NOT NULL,
  `end_time` datetime NOT NULL,
  `sesiune` int(11) NOT NULL
...
CREATE TABLE `studenti` (
  ...
  `email` varchar(32) COLLATE latin1_general_ci NOT NULL,
  `parola` varchar(32) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
  `email_optional` varchar(32) COLLATE latin1_general_ci DEFAULT NULL,
  `sesiune` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
--
-- Indexes for table `perioadainscrieri`
--
ALTER TABLE `perioadainscrieri`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `perioadainscrieri`
--
ALTER TABLE `perioadainscrieri`
...
--
ALTER TABLE `info`
  ADD CONSTRAINT `info_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `admini` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
