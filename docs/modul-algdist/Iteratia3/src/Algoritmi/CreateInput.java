...
public class CreateInput {
    ...
    public static ArrayList<ComisieLicenta> creeazaListaComisii(ArrayList<Profesor> listaProfi) {
    ...
    public static ArrayList<ComisieLicenta> creeazaListaComisiiV2(ArrayList<Profesor> listaProfi, int nrComisii) {
        ArrayList<ComisieLicenta> listaComisii = new ArrayList<>();
        ArrayList<Integer> listaIDProfesoriComisie = new ArrayList<>();
        int num = 1;
        int idComisie = 1;
