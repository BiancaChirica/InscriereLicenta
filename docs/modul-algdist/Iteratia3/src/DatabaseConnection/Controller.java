...
public class Controller {
     ...
     * @throws SQLException if there are problems with the connection to the DataBase
     */
    public void readComisii() throws SQLException {
        ...
        try (Statement stmt = con.createStatement();
            ...
            while (rs.next()) {
                ...
                if(rs.getString("rol").equals("Presedinte")){
                    comisie.setIdProfPresedinte(rs.getInt("idProf"));
                } else if (rs.getString("rol").equals("Secretar"))
                    comisie.setIdProfSecretar(rs.getInt("idProf"));
                else comisie.setIdProf(rs.getInt("idProf"));
            }
        }
    }
