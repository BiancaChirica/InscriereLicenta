...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i=1;i<=100;i++) {
            ...
            ArrayList<ComisieLicenta> listaComisii = start.creeazaListaComisiiV2(listaProfi, 6);
            ...
            listaComisii = (ArrayList<ComisieLicenta>) listaComisii.clone();
    ...
    private static void afisareListaComisii(ArrayList<ComisieLicenta> listaComisii) {
        System.out.println("Comisii:");
        System.out.format("%4s%1s%8s%1s%8s%1s%8s%1s%8s%1s","ID","|","ID ProfP","|","ID Prof2","|","ID Prof3","|","ID ProfS","\n");
        for(ComisieLicenta c : listaComisii) {
            System.out.format("%4s%1s%8s%1s%8s%1s%8s%1s%8s%1s",c.getIdComisie(),"|",c.getIdProfPresedinte(),"|",c.getIdProf2(),"|",c.getIdProf3(),"|",c.getIdProfSecretar(),"\n");
        }
    }
...
/*
    ...
    private static ArrayList<ComisieLicenta> creeazaListaComisii(ArrayList<Profesor> listaProfi) {
        ArrayList<ComisieLicenta> listaComisii = new ArrayList<>();
        ...
        for(Profesor p : listaProfi) {
            ...
            if (num == 4) {
                ...
                ComisieLicenta c = new ComisieLicenta(listaIDProfesoriComisie.get(0), listaIDProfesoriComisie.get(1), listaIDProfesoriComisie.get(2), listaIDProfesoriComisie.get(3));
    ...
    private static ArrayList<ComisieLicenta> creeazaListaComisiiV2(ArrayList<Profesor> listaProfi, int nrComisii) {
        ArrayList<ComisieLicenta> listaComisii = new ArrayList<>();
        ArrayList<Integer> listaIDProfesoriComisie = new ArrayList<>();
        int num = 1;
        int idComisie = 1;
        ...
        for(Profesor p : listaProfi) {
            ...
            if (num == 3) {
                ...
                ComisieLicenta c = new ComisieLicenta(listaIDProfesoriComisie.get(0), listaIDProfesoriComisie.get(1), listaIDProfesoriComisie.get(2), listaIDProfesoriComisie.get(2));
                c.setIdComisie(idComisie);
                listaComisii.add(c);
                idComisie++;
                //reseteaza count-ul
