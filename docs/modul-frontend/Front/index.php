...
<head>
    ...
    <script type="text/javascript" src="javascript/login_index.js"></script>
</head>

<body>

    <div id="header">
        <div class="logo"><a href="index.php"><img src="image/logo-university-small.png" alt="Logo-license"></a></div>
    ...
    <div id="login" class="box">
        <form onsubmit="return false" method="POST" class="box-content animate" id="login_form">
            <div class="container-login">
                ...
                <div class="form">
                    <input type="text" name="log_email" id = "log_email" placeholder="" autocomplete="off" required />
                    <label class="label">
                        <span class="content-span">Email adress</span>
                    </label>
                </div>
                ...
                <div class="form">
                    <input type="password" name="log_password" id = "log_password" placeholder="" autocomplete="off" required />
                    <label class="label">
        ...
        <div id="main-content" class="main-content">
            ...
            <div class="all-information">
                <div class="information-license">
                    ...
                    <div class="information-content">
                        <ul>
                            <> Promovarea tuturor disciplinelor, conform planului de invatamant
                        </ul>
                        <ul>
                            <> Achitarea integrala a tuturor categoriilor de taxe (taxe de scolarizare, de refacere
                                activitate
                                didactica etc. -dupa caz).
                        </ul>
                    </div>
                </div>
