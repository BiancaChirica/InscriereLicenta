    ...
    <form class="box-content animate">
        <div class="container-login">
            ...
            <div class="button-zone">
                <button onclick="location.href='index'" type="button" class="button-back">Back</button>
                <button onclick="location.href='admin_dashboard'" type="button" class="button-register">Register me</button>
            </div>
        </div>
    </form>
</div>
