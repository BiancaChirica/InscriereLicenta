  ...
  <div id="dashboard-content">
    ...
    <div class="container-admin" id="container">
      ...
      <div class="content">
        ...
        <div id="myDIV" >
         <form action="{{URL::to('/edit_accounts_save_profs')}}" method="post">
          {{ csrf_field() }}
          ...
          <br>
           <label for="materialLoginFormEmail">Grad didactic: </label>

          <input type="text" class="form-control" name="grad_didactic" value = " <?= $account_edit->grad_didactic ; ?> ">
          <br>
           <label for="materialLoginFormEmail">Rol in comisie: </label>

          <input type="text" class="form-control" name="rol" value = " <?= $account_edit->rol ; ?> ">
          <br>
